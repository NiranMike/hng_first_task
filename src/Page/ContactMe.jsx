...
const ContactMe = () => {
  ...
  return (
    <div className='py-[90px] contact mx-4 '>
        ...
        <p className='pb-5 text-[#475467] text-[20px] font-normal'>Hi there, contact me to ask about anything you have in mind</p>
        ...
        {/* first name input */}
          <div className=' grid gap-2'>
            ...
            <input onChange={firstNameInput} required value={firstName} className='border focus:outline-none py-2 border-[#D0D5DD] px-3 rounded-[8px]' placeholder='Enter Your first name' id='first_name' type="text" />
          </div>
          {/* last name input */}
          <div className='grid gap-2'>
            <label htmlFor="last_name" className=' font-medium text-[14px]'>Last name</label>
            <input onChange={lastNameInput} required value={lastName} className='border focus:outline-none py-2 border-[#D0D5DD] px-3 rounded-[8px]' placeholder='Enter Your last name' id='last_name' type="text" />
          </div>
        </div>
          {/* email input */}
          <div className=' grid pb-4'>
            <label htmlFor="email" className=' pb-2 font-medium text-[14px]'>Email</label>
            <input onChange={emailInput} required value={email} className='border focus:outline-none py-2 border-[#D0D5DD] px-3 rounded-[8px]' placeholder='yourname@gmail.com' id='email' type="email" />
          </div>
          {/* message textarea */}
          ...
          <div className='flex items-center gap-2'>
            <input onChange={checkbox} checked={check ? true : false} type="checkbox" name="" id="" />
